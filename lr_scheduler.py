...
class NoamScheduler(LRScheduler):
    ...
    def __init__(
        ...
        # LRScheduler.__init__ immediately calls get_lr(), so the two
        # attributes above must be set before this line.
    ...
    def _get_lr_scale(self) -> float:
        ...
        """
        step = self.last_epoch + 1  # step is 1-indexed; avoids step=0
